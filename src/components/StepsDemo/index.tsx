    ...
    <VStack width="100%" p={4}>
      ...
      <VStack pt={4}>
        ...
        <Section
          ...
          subTitle={
            <Text>
              ...
              between <Code>horizontal</Code> (default) and{" "}
              <Code>vertical</Code> layouts. By default, when in mobile view the{" "}
              <Code>Steps</Code> component will switch to <Code>vertical</Code>{" "}
              orientation. To disable this behaviour you can use the{" "}
        ...
        <Section
          ...
          subTitle={
            <Text textAlign="left">
              ...
              indicators, you can do so by using the <Code>icon</Code> prop on
        ...
        <Section
          ...
          subTitle={
            <Text textAlign="left">
              Sometimes it is useful to show visual feedback to the user
